...
# Active audit reference — `citrate-sdk-marketplace`
...
- This repo's folder: `.../per-repo/citrate-sdk-marketplace/` — `MAP.md` (architecture + data-flow +
...
- Phase-1 mapping complete; see `per-repo/citrate-sdk-marketplace/MAP.md` for the mapped surface and
